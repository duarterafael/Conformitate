...
public class ManualTask extends AbstractTaskElement {

	public static final String TAG_NAME = "manualTask";

	public ManualTask(String id, String name, Integer completionQuantity,
