...
public class SortingTable extends JTable {
	...
	public SortingTable(Panel p, Vector<?> data, Vector<?> names) {
	...
	static class SHRenderer extends DefaultTableCellRenderer {
		...
		static Icon ASCENDING = new ImageIcon(SortingTable.class.getClassLoader().getResource("org/yaoqiang/bpmn/editor/images/arrowup.gif"));
		static Icon DESCENDING = new ImageIcon(SortingTable.class.getClassLoader().getResource("org/yaoqiang/bpmn/editor/images/arrowdown.gif"));
