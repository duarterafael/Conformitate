...
public class ProcessPanel extends XMLPanel {
	...
	public ProcessPanel(PanelContainer pc, BPMNProcess owner) {
		super(pc, owner);
	...
	public void saveObjects() {
		...
		if (newId.length() > 0 && !oldId.equals(newId) && definitions.getProcess(newId) == null) {
			...
			JOptionPane.showMessageDialog(null, mxResources.get("warningElementWithTheSameIdAlreadyExists"), mxResources.get("WarningConflict"),
