...
public class CallActivityPanel extends XMLPanel {
	...
	public CallActivityPanel(PanelContainer pc, CallActivity owner) {
		super(pc, owner);
	...
	public void saveObjects() {
		...
		if (newCalledElement.length() > 0) {
			if (newCalledElement.equals(idPanel.getText())) {
				JOptionPane
						.showMessageDialog(null, mxResources.get("WarningCallActivityCannotCallItself"), mxResources.get("Warning"), JOptionPane.WARNING_MESSAGE);
				return;
			}
