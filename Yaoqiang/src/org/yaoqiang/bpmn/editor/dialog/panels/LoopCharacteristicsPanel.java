...
public class LoopCharacteristicsPanel extends XMLPanel {
	...
	public LoopCharacteristicsPanel(PanelContainer pc, LoopCharacteristics owner) {
		super(pc, owner);
		...
		if (owner instanceof StandardLoopCharacteristics) {
			...
			inputDataItemPanel.setBorder(BorderFactory.createTitledBorder(mxResources.get("inputDataItem")));
			outputDataItemPanel = new DataObjectPanel(pc, (DataOutput) owner.get("outputDataItem"));
			outputDataItemPanel.setBorder(BorderFactory.createTitledBorder(mxResources.get("outputDataItem")));
