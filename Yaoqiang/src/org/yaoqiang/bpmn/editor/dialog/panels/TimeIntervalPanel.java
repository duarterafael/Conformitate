...
public class TimeIntervalPanel extends XMLPanel {
	...
	public TimeIntervalPanel(final PanelContainer pc, XMLElement owner) {
		this(pc, owner, true);
	}

	public TimeIntervalPanel(final PanelContainer pc, XMLElement owner, boolean enabled) {
		super(pc, owner);
	...
	public String buildExpression() {
		...
		if (expression.length() == 0) {
			if (start.length() == 0 || end.length() == 0) {
				JOptionPane.showMessageDialog(null, "Invalid time interval!", mxResources.get("Warning"), JOptionPane.WARNING_MESSAGE);
				return "";
			} else {
