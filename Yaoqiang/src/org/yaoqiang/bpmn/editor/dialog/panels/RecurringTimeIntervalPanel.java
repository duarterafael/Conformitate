...
public class RecurringTimeIntervalPanel extends XMLPanel {
	...
	public RecurringTimeIntervalPanel(final PanelContainer pc, XMLElement owner) {
		this(pc, owner, true);
	}

	public RecurringTimeIntervalPanel(final PanelContainer pc, XMLElement owner, boolean enabled) {
		super(pc, owner);
		...
		JLabel pl = new JLabel(mxResources.get("duration") + ": ");
		JLabel yearLabel = new JLabel(mxResources.get("year") + ",");
		JLabel monthLabel = new JLabel(mxResources.get("month") + ",");
		JLabel dayLabel = new JLabel(mxResources.get("day") + ",");
		JLabel hourLabel = new JLabel(mxResources.get("hour") + ",");
		JLabel minuteLabel = new JLabel(mxResources.get("minute") + ",");
		JLabel secondLabel = new JLabel(mxResources.get("second"));
		...
		JLabel cl = new JLabel(mxResources.get("cycle") + ": ");
		JLabel sl = new JLabel(mxResources.get("start") + ": ");
		sf = new JTextField();
		...
		startButton.setToolTipText(mxResources.get("selectDateTime"));
		startButton.addActionListener(dateTimeChooserAction);
		JLabel el = new JLabel(mxResources.get("end") + ": ");
		ef = new JTextField();
		...
		endButton.setToolTipText(mxResources.get("selectDateTime"));
	...
	public String buildExpression() {
		...
		if (expression.length() == 0) {
			if (start.length() == 0 || end.length() == 0) {
				JOptionPane.showMessageDialog(null, "Invalid recurring time interval!", mxResources.get("Warning"), JOptionPane.WARNING_MESSAGE);
				return "";
			} else {
