...
public class RetrieveDefinitionsPanel extends JSONPanel {
	...
	public RetrieveDefinitionsPanel(final PanelContainer pc, final BPMNEditor owner) {
		super(pc, owner);
		...
		editButton.addActionListener(new AbstractAction("edit") {
			...
			public void actionPerformed(ActionEvent e) {
				owner.createDialog().initDialog().editObject(RetrieveDefinitionsPanel.this, owner, "engineConnections");
			}
