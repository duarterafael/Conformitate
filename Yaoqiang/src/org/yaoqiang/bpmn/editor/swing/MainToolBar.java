...
public class MainToolBar extends JToolBar {
	...
	public MainToolBar(final BaseEditor editor, int orientation) {
		...
		add(editor.bind(mxResources.get("paste"), TransferHandler.getPasteAction(), "/org/yaoqiang/bpmn/editor/images/paste.png"));
		...
		add(editor.bind(mxResources.get("redo"), EditorActions.getAction(EditorActions.REDO), "/org/yaoqiang/bpmn/editor/images/redo.png"));
		...
		add(editor.bind(mxResources.get("bold"), EditorActions.getFontStyleAction(mxConstants.FONT_BOLD), "/org/yaoqiang/bpmn/editor/images/bold.gif"));
		add(editor.bind(mxResources.get("italic"), EditorActions.getFontStyleAction(mxConstants.FONT_ITALIC), "/org/yaoqiang/bpmn/editor/images/italic.gif"));

		addSeparator();

		add(editor.bind(mxResources.get("left"), EditorActions.getKeyValueAction(mxConstants.STYLE_ALIGN, mxConstants.ALIGN_LEFT),
				"/org/yaoqiang/bpmn/editor/images/left.gif"));
		add(editor.bind(mxResources.get("center"), EditorActions.getKeyValueAction(mxConstants.STYLE_ALIGN, mxConstants.ALIGN_CENTER),
				"/org/yaoqiang/bpmn/editor/images/center.gif"));
		add(editor.bind(mxResources.get("right"), EditorActions.getKeyValueAction(mxConstants.STYLE_ALIGN, mxConstants.ALIGN_RIGHT),
				"/org/yaoqiang/bpmn/editor/images/right.gif"));

		addSeparator();

		add(editor.bind(mxResources.get("FontColor"), EditorActions.getColorAction(mxResources.get("fontColor"), mxConstants.STYLE_FONTCOLOR),
		...
		add(editor.bind(mxResources.get("FillColor"), EditorActions.getColorAction(mxResources.get("fillColor"), mxConstants.STYLE_FILLCOLOR),
	...
	protected void populateFileToolbar(BaseEditor editor) {
		add(editor.bind(mxResources.get("new"), ModelActions.getAction(ModelActions.NEW), "/org/yaoqiang/bpmn/editor/images/new.png"));
		add(editor.bind(mxResources.get("OpenFile"), ModelActions.getAction(ModelActions.OPEN), "/org/yaoqiang/bpmn/editor/images/open.png"));
		add(editor.bind(mxResources.get("OpenURL"), ModelActions.getAction(ModelActions.OPEN_URL), "/org/yaoqiang/bpmn/editor/images/openurl.png"));
		add(editor.bind(mxResources.get("reload"), ModelActions.getAction(ModelActions.RELOAD), "/org/yaoqiang/bpmn/editor/images/reload.png"));
		add(editor.bind(mxResources.get("save"), ModelActions.getSaveAction(), "/org/yaoqiang/bpmn/editor/images/save.png"));
		add(editor.bind(mxResources.get("saveAs"), ModelActions.getSaveAsAction(), "/org/yaoqiang/bpmn/editor/images/save_as.png"));
		add(editor.bind(mxResources.get("saveAsPNG"), ModelActions.getSaveAsPNG(), "/org/yaoqiang/bpmn/editor/images/png.png"));
		add(editor.bind(mxResources.get("saveAsODT"), ModelActions.getSaveAsODT(), "/org/yaoqiang/bpmn/editor/images/odt.png"));

		addSeparator();
		add(editor.bind("Export Use", ModelActions.getExportUse(), "/org/yaoqiang/bpmn/editor/images/exportUse.png"));
		addSeparator();
		

		add(editor.bind(mxResources.get("pageSetup"), GraphActions.getAction(GraphActions.PAGE_SETUP), "/org/yaoqiang/bpmn/editor/images/page_setup.png"));
		add(editor.bind(mxResources.get("print"), GraphActions.getAction(GraphActions.PRINT), "/org/yaoqiang/bpmn/editor/images/printer.png"));

		addSeparator();

		add(editor.bind(mxResources.get("SaveToNativeRepo"), ModelActions.getAction(ModelActions.SAVE_TO_REPO),
				"/org/yaoqiang/bpmn/editor/images/save_to_repo.png"));
		add(editor.bind(mxResources.get("versionHistory"), ModelActions.getAction(ModelActions.VERSION_HISTORY),
				"/org/yaoqiang/bpmn/editor/images/version_history.png"));
		add(editor.bind(mxResources.get("DeployProcessDefinition"), ModelActions.getAction(ModelActions.DEPLOY), "/org/yaoqiang/bpmn/editor/images/deploy.png"));

		addSeparator();

		add(editor.bind(mxResources.get("run"), ModelActions.getAction(ModelActions.RUN_SIMULATION), "/org/yaoqiang/bpmn/editor/images/run.png"));
		add(editor.bind(mxResources.get("pause"), ModelActions.getAction(ModelActions.PAUSE_SIMULATION), "/org/yaoqiang/bpmn/editor/images/pause.png"));
		add(editor.bind(mxResources.get("stop"), ModelActions.getAction(ModelActions.STOP_SIMULATION), "/org/yaoqiang/bpmn/editor/images/stop.png"));
	}
